...
public class Peer2 extends Thread{
	 ...
	 */
	public Peer2(final int port, String ipAddress,String sharedFilePath,String outputPath) {
	...
	public void query()
	{
	  ...
	  public void run()
      {
  		...
  		while(true)
		{
			...
			{
				System.out.println("Neighbor received");
				boolean found = false;
				String output ="";
				for(int i=0;i<neighborInfoList.size();i++)
				{
	...
	public static void main(String[] args) {
					...
					Peer2 window = new Peer2(2222,"localhost","input2","output2");
