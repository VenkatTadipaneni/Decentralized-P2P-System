...
public class Peer1 extends Thread{
	 ...
	 */
	public Peer1(final int port, String ipAddress,String sharedFilePath,String outputPath) {
	...
	public static void main(String[] args) {
					...
					Peer1 window = new Peer1(1111,"localhost","input1","output1");
