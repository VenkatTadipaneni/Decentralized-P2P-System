...
public class Peer5 extends Thread{
	 ...
	 */
	public Peer5(final int port, final String ipAddress,String sharedFilePath,String outputPath) {
	 ...
	 */
	   public static void main(String[] args) throws UnknownHostException {
			...
			Peer5 window = new Peer5(5555,ip.getHostAddress(),"input5","output5");
