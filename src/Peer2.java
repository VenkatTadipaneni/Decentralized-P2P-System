...
public class Peer2 extends Thread{
	 ...
	 */
	public Peer2(final int port, final String ipAddress,String sharedFilePath,String outputPath) {
	 ...
	 */
	   public static void main(String[] args) throws UnknownHostException {
			...
			Peer2 window = new Peer2(2222,ip.getHostAddress(),"input2","output2");
