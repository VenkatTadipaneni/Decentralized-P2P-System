...
public class Peer1 extends Thread{
	 ...
	 */
	public Peer1(final int port, final String ipAddress,String sharedFilePath,String outputPath) {
	 ...
	 */
	   public static void main(String[] args) throws UnknownHostException {
			...
			Peer1 window = new Peer1(1111,ip.getHostAddress(),"input1","output1");
