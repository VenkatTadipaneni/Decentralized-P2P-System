...
public class Peer3 extends Thread{
	 ...
	 */
	public Peer3(final int port, final String ipAddress,String sharedFilePath,String outputPath) {
	 ...
	 */
	   public static void main(String[] args) throws UnknownHostException {
			...
			Peer3 window = new Peer3(3333,ip.getHostAddress(),"input3","output3");
